...
const Navigation = () => {
  ...
  return <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? "glass-effect backdrop-blur-xl border-b border-border/50" : "bg-transparent"}`}>
