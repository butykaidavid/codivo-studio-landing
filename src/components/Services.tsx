  ...
  return <section className="py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-6xl font-bold mb-8 font-display bg-gradient-primary bg-clip-text text-transparent py-[34px]">
            Szolgáltatásaink
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => <Card key={index} className="group hover:scale-105 transition-all duration-500 glass-effect hover:border-primary/50 overflow-hidden">
              ...
              <CardContent className="text-center relative z-10">
                ...
                <ul className="space-y-2">
                  {service.features.map((feature, idx) => <li key={idx} className="text-sm text-muted-foreground flex items-center justify-center font-light">
